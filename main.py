...
ticker = "ABEV3"
periodo = "5d"  # 1d,5d,1mo,3mo,6mo,1y,2y,5y,10y,ytd,max

hist = retorna_cotacao_acao_historica(ticker, periodo=periodo)
...
if __name__ == "__main__":
  ...
  print("#* Bem Vindos ao Chatbot Financeiro da Stack2u")
  print()
  ...
  while True:
    ...
    mensagens = gera_texto(mensagens=mensagens)
